...
STAGE_2_MAPPING = [
    {"subject": "Legal", "pdf_page": 151, "chapter": 11}, # Legal Comprehension
    {"subject": "English", "pdf_page": 211, "chapter": 74}, # English Comprehension
    {"subject": "English", "pdf_page": 301, "chapter": 71}, # Foreign Phrases
    {"subject": "Quant", "pdf_page": 31, "chapter": 90}  # Math Practice
]

def ingest_stage_2():
    print("Starting Stage 2 Ingestion...")
    
    for item in STAGE_2_MAPPING:
        ...
        try:
            ...
            os.makedirs("scratch/stage2", exist_ok=True)
            output_file = f"scratch/stage2/{subject}_Ch{chapter}.md"
